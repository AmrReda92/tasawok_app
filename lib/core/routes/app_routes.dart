...
import 'package:practise_three/features/product/data/repos/product_repo_impl.dart';
...
class AppRoutes {
  static Route<dynamic>? function(RouteSettings setting) {
    ...
    final String categoryName = setting.arguments as String;
        return MaterialPageRoute(builder: (_) =>
            BlocProvider(
              create: (context) => GetProductsCubit(ProductRepoImpl(ApiService(Dio())))..getProductsByCategory( categoryName),
              child: ProductScreen(),
            ));
